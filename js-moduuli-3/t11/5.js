...
const modal_pic = document.getElementById("modal_pic");


for (const picArrayElement of picArray) {

  const title = document.createTextNode(picArrayElement.title);
  const caption = document.createTextNode(picArrayElement.caption);
  const description = document.createTextNode(picArrayElement.description);
  const image = document.createTextNode(picArrayElement.image);
  ...
  img.src = `${picArrayElement.image.medium}`;
  img.alt = `${picArrayElement.title}`;
  ...
  article.addEventListener("click", function (click_event){
  modal.showModal()
  modal_pic.src = `${picArrayElement.image.large}`;
  modal_pic.alt = `${picArrayElement.title}`;

      document.getElementById("close_modal").addEventListener("click", function( close){
